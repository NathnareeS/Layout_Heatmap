...
### Improved
- **Dramatically faster startup time**: Switched from single-file to folder mode
  - Startup time reduced from 5-15 seconds to 1-2 seconds
  - Application now distributed as a folder instead of single .exe
